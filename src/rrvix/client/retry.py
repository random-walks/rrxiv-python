"""Retry policy for the rrvix HTTP client.
...
behaviour pass their own :class:`RetryPolicy` to ``RrvixClient``.
"""
...
class RetryPolicy:
    """Retry configuration for an :class:`rrvix.client.RrvixClient`.
