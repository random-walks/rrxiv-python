...
IDs and whose edges are the four edge kinds rrvix defines:
``depends_on``, ``supports``, ``contradicts``, ``extends``.

Construction is from a :class:`rrvix.models.CIR` (or directly from
...
from rrvix.models import CIR, Claim
